...
DATABASES['default'] = dj_database_url.parse('postgresql://trashandler_fdno_user:UCEA6v6OUtoKAnPeiwJTmn4q0jnokruB@dpg-cqkgcbqju9rs738nmoh0-a.oregon-postgres.render.com/trashandler_fdno')
...
ALLOWED_HOSTS = ['trashandler-api-s-1-259j.onrender.com']
